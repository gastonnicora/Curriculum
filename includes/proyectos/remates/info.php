<div class="container">
    ...
    <ul>
        <li>Comunicación en tiempo real entre servidor y cliente </li>
        <li>Manejo de tareas asíncronas</li>
    </ul>

    <h5>Tecnologías Utilizadas</h5>
    <p> <i class="fab fa-vuejs"></i> Vue.js, Vue Router, Vuex, Socket.io,<i class="fab fa-docker"></i> Docker, <i class="fab fa-python"></i> Flask, Celery, Redis, MariaDB, <i class="fa-brands fa-git-alt"></i>Git.</p>
